...
% WBILERPG - Weighted bilinear interpolation weights (GPU-enabled)
%
...
switch uclass
    case "double",suffix = "";
    case "single",suffix = "f";
    case "halfT", suffix = "h"; cxy = alias(cxy); % ensure aliased - we can index directly
end
...
for ineg = [false, true], for isteep = [false, true], for irev = [false, true]
            ...
            kern.ThreadBlockSize = min(I,kern.MaxThreadsPerBlock);
